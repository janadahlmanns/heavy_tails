...
ax_network.set_xlabel('X', fontsize=10, color='white')
ax_network.set_ylabel('Y', fontsize=10, color='white')
ax_network.tick_params(labelsize=8, labelbottom=True, labelleft=True, colors='white')
# Hide all spines on network plot
...
ax_network.spines['bottom'].set_edgecolor('white')
ax_network.spines['left'].set_edgecolor('white')
